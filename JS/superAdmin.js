  ...
  if (!form.dataset.bound) {
    ...
    activateBusinessButton?.addEventListener('click', async (e) => {
      ...
      const accessTypeCheckboxes = document.querySelectorAll(
        'input[name="activateSubcriptionAccessType"]:checked',
      );

      //  duration type checkboxes
      const durationCheckboxes = document.querySelectorAll(
        'input[name="subscriptionDuration"]:checked',
      );
      ...
      const businessSubscriptionDetails = {
        ...
        services: accessType,
        billing_cycle: durationCheckboxes.value,
      };
